...
The coverage command gives only the development collector a 4 GiB V8 heap so
the roughly 2,000 raw subprocess captures can be merged deterministically; it
does not alter the CLI/runtime heap or any published execution contract.
