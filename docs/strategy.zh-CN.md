...
[安全、可信与业务本体提案](trust-ontology.zh-CN.md)把本策略的岗位、Context、权限和
执行证据串成可审查的业务工作回路：先完成有来源的对象/关系与只读建议，再以单独的授权、
审批、幂等和回读门槛开放有界行动。它是需求 #346 R1 的设计产物，不新增已交付能力，
也不修改下述产品范围、W1 gate 或里程碑承诺。
