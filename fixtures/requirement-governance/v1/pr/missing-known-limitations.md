...
This intentionally incomplete fixture omits one required heading and changes
no product behavior.

## Validation

- Exact commands: `npm run governance:check`
- Observed counts/results: PASS, 1/1 expected missing-heading result observed
...
|---|---|---|---|---|---|---|---|
| V1 | REQ-003 / AC-003 | Incomplete PR trace fails closed | `npm run governance:check` | Node.js 20+ repository root | One exact missing-heading error | One exact missing-heading error | PASS |
